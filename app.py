...
diabetes_model = pickle.load(open("D:\ML project\multiple-disease-prediction-streamlit-app-main\multiple-disease-prediction-streamlit-app-main\saved_models\diabetes_model.sav", 'rb'))

heart_disease_model = pickle.load(open("D:\ML project\multiple-disease-prediction-streamlit-app-main\multiple-disease-prediction-streamlit-app-main\saved_models\heart_disease_model.sav", 'rb'))

parkinsons_model = pickle.load(open("D:\ML project\multiple-disease-prediction-streamlit-app-main\multiple-disease-prediction-streamlit-app-main\saved_models\parkinsons_model.sav", 'rb'))
